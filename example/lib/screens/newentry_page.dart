...
import 'package:finan_ledger/models/expenseScope.dart';
import 'package:finan_ledger/theme/colors/colors.dart';
...
class NewEntryLog extends StatefulWidget {
  ...
  final int index;
  NewEntryLog({Key? key, required this.callback, required this.context, this.index = -999}) : super(key: key);
  @override
